  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mb-6">
        <form method="GET" className="flex gap-2">
          <div className="relative flex-1">
            ...
            <Input name="q" defaultValue={query} placeholder="Search problems..." className="pl-10" />
          </div>
      ...
      {query && (
        <div className="mb-4">
          <p className="text-muted-foreground">
            {problems.length} result{problems.length !== 1 ? "s" : ""} for "{query}"
          </p>
        </div>
      )}
      ...
      {problems.length > 0 ? (
        ...
        <div className="text-center py-8">
          <p className="text-muted-foreground">Enter a search term to find problems.</p>
        </div>
      )}
    </div>
  )
